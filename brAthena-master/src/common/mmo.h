...
/// Nível Max. de Base - Suporta até nível de base 1000
	BASE_MAX_1LV	= 300,	// Classes Normais e Classes Baby.
	BASE_MAX_2LV	= 300,	// Classes Transcedentais.
	BASE_MAX_3LV	= 300,	// Terceira Classe Normal, Terceira Classe Bebê.
	BASE_MAX_4LV	= 300,	// Super Aprendiz Expandido e Kagerou/Oboro.
/// Nível Max. de Classe - Suporta até nível de classe 255
	...
	JOB_MAX_6LV		= 150,	// Segunda Classe Transcedental.
	JOB_MAX_7LV		= 60,	// Terceira Classe, Terceira Classe Bebê.
	JOB_MAX_8LV		= 150,	// Super Aprendiz Expandido e Kagerou/Oboro.
	JOB_MAX_9LV		= 150,	// Ninja/Gunslinger.
	JOB_MAX_10LV	= 50,	// Taekwon.
	JOB_MAX_11LV	= 150,	// Mestre Taekwon.
	JOB_MAX_12LV	= 150,	// Espiritualista.
	JOB_MAX_13LV	= 150,	// Super Aprendiz & Bebê Super Aprendiz.
};
