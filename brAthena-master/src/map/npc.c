                               ...
                               if ( w4[i] != ' ' && w4[i] != ' ' && w4[i] != ',' && w4[i] != '\0' ) {
                                       ...
                                       if ( !strcmp( temp, "IT_HEALING" ) || !strcmp( temp, "0" ) )
                                               ...
                                               if ( i_data )
                                                       ...
                                                       map->list[m].noitemlist[i] = -1;
                                               }
                                       }
                                       else {
                                               id = atoi(temp);
                                               if ( itemdb->exists(id) )
                                                       map->list[m].noitemlist[i] = id;
                                               else {
